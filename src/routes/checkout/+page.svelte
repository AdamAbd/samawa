...
<div class="bg-gray-100">
	...
	<main class="container mx-auto mt-[114px] py-10">
		...
		<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
					...
					<div class="content">
						...
						<div class="space-y-2">
							<div class="flex justify-between">
								...
								<span class="font-semibold"> 1 Wedding Package Platinum </span>
							</div>
							<div class="flex justify-between">
								<span class="flex items-center">
								...
								<span class="font-semibold"> Rp 255.500.000 </span>
							</div>
							<div class="flex justify-between">
								<span class="flex items-center">
								...
								<span class="font-semibold"> Rp 28.105.000 </span>
							</div>
							<div class="flex justify-between">
								<span class="flex items-center">
							...
							<div class="flex justify-between font-bold text-black">
								...
								<span class="text-pink-500"> Rp 283.605.000 </span>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="space-y-6">
				<div class="bg-white p-6 rounded-lg shadow-sm">
					<h2 class="text-xl font-semibold mb-4">GOLD</h2>
					<img
						alt="Wedding image"
						...
						width="300"
					/>
					<div class="text-pink-500 text-2xl font-bold mb-10">Rp 225.500.000</div>
					<hr class="my-5" />
					<div class="mb-10">
