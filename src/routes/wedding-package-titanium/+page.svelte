<script>
    import '../wedding-package-titanium/style.css';
  ...
  <div class="container">
    ...
    <div class="package-header">
      <div class="header-left">
        <h1 class="package-title">TITANIUM</h1>
        <p class="package-location"><img class="location-icon" src={loc_icon} alt=""> Jakarta, Indonesia</p>
      </div>
      ...
      <div class="header-right">
        ...
        <span class="review-count">22,354</span>
      </div>
    </div>
    ...
    <div class="content">
        <div class="package-details">
            ...
            <h2 class="text-lg font-bold mt-8 mb-4">PAKET WEDDING TITANIUM</h2>
            ...
            <ul class="list-disc list-inside pl-4">
                <li>Dekorasi Premium yang disesuaikan dengan tema pilihan</li>
                <li>Backdrop Resepsi yang elegan</li>
                <li>Piring makan + sendok + garpu 300 pcs</li>
                <li>Meja Buffe 8</li>
            </ul>
      ...
      <div class="price-container">
        <div class="price">Rp 155.350.000</div>
        <hr class="divider" />
        <hr class="divider" />
